...
contract EarnERC777 is IERC777, IERC20 {
    ...
    IERC1820Registry internal _erc1820 = IERC1820Registry(0x692a70D2e424a56D2C6C27aA97D1a86395877b3A);
...
contract Token is EarnERC777, MinterRole, Pausable, SwitchTransferable {
    address internal _revenueAddress;
    bool private _activated;

    constructor() EarnERC777("CNYx","Token Stable Coin", 18) public {
    }
    ...
    function init(
        ...
        public
    {
        require(!_activated, "already active, can only be activated once");
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
        _erc1820 = IERC1820Registry(erc1820);
        _erc1820.setInterfaceImplementer(address(this), keccak256("ERC777Token"), address(this));
        _erc1820.setInterfaceImplementer(address(this), keccak256("ERC20Token"), address(this));
        _owner = owner;
        _activated = true;
